...
class SABankingDataGenerator:
    def __init__(self, num_transactions=100000, start_date='2023-01-01', end_date='2024-11-23'):
        ...
        self.sa_cities = ['Johannesburg', 'Cape Town', 'Durban', 'Pretoria', 'Port Elizabeth',
        ...
        # South African public holidays (2023-2024)
        self.sa_holidays = {
    ...
    def generate_accounts(self, customers_df):
        ...
        for _, customer in customers_df.iterrows():
            # Each customer can have 1-4 accounts
    ...
    def generate_transactions(self, accounts_df):
        ...
        for _ in range(self.num_transactions):
            ...
            transactions.append({
                ...
                'merchant_name': self.fake.company() if transaction_type in ['Card Payment', 'Online Payment'] else None,
    ...
    def generate_time_dimension(self):
        ...
        # Start date should be the first day of the year of start_date
        time_start = datetime(self.start_date.year, 1, 1)
        # End date should be the last day of the year of end_date
        ...
        while current_date <= time_end:
            ...
            dates.append({
                ...
                'day_of_week': current_date.weekday() + 1,  # 1-7 instead of 0-6
